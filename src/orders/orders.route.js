...
const app = express();
app.use(cors({ origin: "https://www.aliezom.com" }));
...
router.post("/create-checkout-session", async (req, res) => {
  ...
  try {
    ...
    const data = {
      ...
      mode: "payment",
      products: lineItems,
      success_url: "https://www.aliezom.com/SuccessRedirect?client_reference_id=" + nowId,
      cancel_url: "https://www.aliezom.com/cancel",
      metadata: {
